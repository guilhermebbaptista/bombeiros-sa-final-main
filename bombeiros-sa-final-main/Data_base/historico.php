...
$sql = "
    SELECT *
    FROM acompanhante
    JOIN anamnese_emerg ON acompanhante.ID_ACOMPANHA = anamnese_emerg.fk_acompanhante  <--- <fazer ligação>
...
if ($result) {
    ...
    echo "Erro na conexao de dados, por favor constate um administrador: " . $conn->error;
}
